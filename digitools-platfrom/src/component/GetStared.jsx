      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="relative group bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300">
            ...
            <div className="mx-auto flex items-center justify-center h-20 w-20 rounded-full bg-purple-50 mb-6"> <img src="/user-01.png" alt="User" />
            </div>
          ...
          <div className="relative group bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300">
            ...
            <div className="mx-auto flex items-center justify-center h-20 w-20 rounded-full bg-purple-50 mb-6">
                <img src="/Box.png" alt="Select" />
          ...
          <div className="relative group bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300">
            ...
            <div className="mx-auto flex items-center justify-center h-20 w-20 rounded-full bg-purple-50 mb-6"><img src="/Rocet.png" alt="" />
            </div>
